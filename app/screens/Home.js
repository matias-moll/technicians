...
import WorkOrderClientInfo from '../components/WorkOrderClientInfo';
  ...
  return (
    <Screen bottomAction={action}>   
      <View style={styles.topContainer}> 
        <WorkOrderHeader headerInfo={workOrder.orderInfo} />
        <WorkOrderClientInfo detailsInfo={workOrder.clientInfo} />
        <WorkOrderNote note={workOrder.note} />
      </View>
    </Screen>
  )
}
